...
--
-- Gép: 127.0.0.1
-- Létrehozás ideje: 2026. Már 12. 11:50
...
(23, 1, 8, '2026-02-19 13:57:59', 3, 0),
(24, 2, 8, '2026-02-19 14:02:09', 1, 1),
(25, 2, 8, '2026-02-19 14:02:19', 1, 1),
(26, 2, 8, '2026-02-19 14:04:24', 1, 3),
(27, 1, 8, '2026-02-19 14:05:36', 1, 4),
(28, 1, 8, '2026-02-20 09:03:24', 2, 0),
(29, 0, 6, '2026-03-06 12:45:03', 1, 1),
(30, 0, 8, '2026-03-06 13:05:11', 1, 1),
(31, 1, 8, '2026-03-06 13:05:27', 1, 4),
(34, 1, 8, '2026-03-12 11:36:07', 1, 0),
(36, 1, 8, '2026-03-12 11:42:52', 0, 3);
...
(121, 'A nagyfelbontású monitor azt jelenti, hogy…', 'a monitor sok színt tud kezelni.', 'a monitor képfrissítése: 120 Hz, vagy több.', 'a monitor képpontjainak száma vertikálisan és horizontálisan is nagy.', 'a monitor képátlója 22”, vagy anná l nagyobb.', '', '', 'C', '', 3, 1, 2),
(122, 'Melyik állítás igaz?', 'A programok szerzői jogát a törvény nem, csak a BSA védi.', 'A megvásárolt program egy adásvétel keretében eladható.', 'A szoftverhez mellékelt dokumentáció nem tartozik a szerzői jog védelme alá.', 'A freeware és s hareware ugyanazt jelenti.', '', '', 'B', '', 3, 1, 2),
(123, 'Melyik állítás igaz az M2M technológiára?', 'Az M2M technológi a az emberek közötti biztonságos és titkosított kommunikációt valósítja meg.', 'Az M2M technológia olyan adatáramlást jelent, mely emberi közreműködés nélkül, gépek között zajlik.', 'Az M2M technológia a csoportmunka legújabb, egyben legfontosabb kommunikációs eszköze.', 'Az M2M technológia minimum 20Gbit/s -os vonalon valósítható csak meg.', '', '', 'B', '', 3, 1, 2),
(124, 'Ohm törvényének felhasználásával válassza ki, hogy mennyi lesz az U értéke, ha az R=76Ω és az I=1,2A?', '100V', '91,2V', '63,3V', '15,7V', '', '', 'B', '', 3, 1, 2),
(125, 'Melyik pixelgrafikus fájlformátum az alábbiak közül?', 'PDF', 'CDR', 'BMP', 'SWF', '', '', 'C', '', 3, 1, 2),
(126, 'A felsorolt eszközök közül melyik nem periféria?', 'Mikrofon', 'CPU (Central Processing Unit)', 'Játékvezérlő', 'Hangkártya', '', '', 'B', '', 3, 1, 2),
(127, 'Mit jelent az EULA?', 'elolvasása után lesz jogunk használni egy programot', 'végfelhasználói licencszerződés', 'szabad szoftverek használatát szabályozó szerződés', 'csak az EULA jogköre alá tartozó szoftverek létezhetnek', '', '', 'B', '', 3, 1, 2),
(128, 'Mekkora a Class 1 Bluetooth maximális hatótávolsága?', '20 m', '50 m', '10 m', '100 m', '', '', 'D', '', 3, 1, 2),
(129, 'Az alábbi állítások közül melyik igaz a vírusokra?', 'Ha a rendszerbe vírus került, semmiképp sem irthat ó le a merevlemezen lévő vírusirtóval. Ki kell venni a rendszerlemezt és másik gépbe helyezni a sikeres írtáshoz .', 'Megfertőzheti a merevlemez boot szektorát, végső soron akár a teljes merevlemez tartalma elveszhet.', 'A vírusok egy speciális fajtája az elektro nikus sugárzáson keresztül is terjed, így egy kis irodában lévő minden számítógép gyorsan megfertőződhet.', 'A számítógépes vírusok egymásnak is ártanak, ezért egy gépen egyszerre csak egy vírus lehet jelen.', '', '', 'B', '', 3, 1, 2),
(130, 'Melyik parancs segítségével törölhető Linuxos rendszeren egy könyvtárból az\nösszes, csak „archiv” karakterekkel kezdődő állomány?', 'rm a*', 'del archiv*', 'rm archiv', 'rm archiv*', '', '', 'D', '', 3, 1, 2),
(131, 'Melyik a processzor órajel lehetséges értéke napjainkban asztali számítógépek esetén?', '2,2 kHz', '3,2 MHz', '4,2 GHz', '5,2 THz', '', '', 'C', '', 3, 1, 2),
(132, 'Melyik állítás helyes?', 'A RAM tartalma szabadon módosítható, nem úgy, mint a merevlemezé.', 'A HDD egy memóriatípust jelent, és a High Density Data storage rövidítése.', 'Mentéskor az adat háttértárolóra kerül.', 'Egy BR-ROM meghajtó általában gyorsabb eszköz, mint a merevlemez.', '', '', 'C', '', 3, 1, 2),
(133, 'Mely adathordozó nem formázható?', 'Merevlemez', 'USB pen drive', 'SD kártya', 'DVD -ROM', '', '', 'D', '', 3, 1, 2),
...
(135, 'Jelölje az igaz állítást!', 'A biztonsági másolatot csak a rendszergazda készíthet a gépünk állományairól .', 'Az operációs rendszerek általában támogatják a biztonsági másolatok készítését.', 'Hardverhiba nem okozhat adatvesztést, így a biztonsági másolatok elsősorban a véletlen törlések és a vírusok ellen védenek.', 'Biztonsági másolat csak cserélhető adathordozóra készít hető.', '', '', 'B', '', 3, 1, 2),
(136, ' Az alábbi eszközök közül melyikről nem lehet betölteni egy Pc operációs\nrendszerét? ', 'floppy lemez', 'CD-ROM', 'streamer kazetta', 'pendrive', '', '', 'C', '', 3, 1, 2),
(137, 'Egy CAD/CAM munkaállomás kialakításánál mely hardvereszköz kiemelt\nszerepű az alábbiak közül?', 'nagy teljesítményű videókártya', 'csúcsminőségű hangkártya', 'DisplayPort', 'fejlett hűtéstechnika', 'HDMI/DVI kimenet', '', 'A', '', 3, 1, 2),
(138, 'Milyen színrendszert használnak a monitorok?', 'HSV', 'RGB', 'CMYK', 'CRY', '', '', 'B', '', 3, 1, 2),
(139, 'Mi a funkciója az eseménynaplónak?', 'A felhasználok neveit és jelszavait tárolja.', 'A felhasználók kedvenc weboldalait tárolja.', 'A vírusdefiníciós adatbázist tárolja.', 'A gép hardveres és szoftveres változásainak nyomon követését segíti elő.', '', '', 'D', '', 3, 1, 2),
(140, 'Melyik a Windows 10 alapértelmezett fájlrendszere?', 'exFAT', 'NTFS', 'FAT32', 'EXT4', '', '', 'B', '', 3, 1, 2),
(141, 'Videokártyacsere esetén mely szempont a legfontosabb? ', 'a gépbe szerelt RAM mérete', 'a gép CPU típusa', 'a beépített HDD mérete', 'az alaplapi bővítőhely típusa', '', '', 'D', '', 3, 1, 2),
(142, ' Melyik állítás igaz a RAM-ra?', 'Írható -olvasható.', 'Csak olvasható.', 'Soros elérésű.', 'Olyan memória, amely kikapcsolás után is megőrzi tartalmát.', '', '', 'A', '', 3, 1, 2),
(143, 'Az alábbi eszközök közül melyiken szabad töredezettség mentesítést végezni?', 'HDD', 'Blu-Ray lemez', 'SD kártya', 'SSD meghajtó', '', '', 'A', '', 3, 1, 2),
(144, 'Melyik rövidítés port az alábbiak közül?', 'SCSI', 'RFI', 'UTP', 'UPS', '', '', 'A', '', 3, 1, 2),
(145, ' Egy videokártyán 600x400 képpont felbontásában 2 szín használható (fekete és\nfehér). Legalább mekkora memóriára van szüksége ennek megjelenítéséhez?', '240 000 Bájt', '30 000 Bájt', '0,24 Mbájt', '0,3 MBájt', '', '', 'B,D', '', 3, 1, 4),
(146, 'Mi a CACHE funkciója?', 'Lehetővé teszi a számítógép számára a hálózathoz való csatlakozást.', 'A játékok és grafikus alkalmazások számára illesztő felületet biztosít.', 'A számítógép bekapcsolásakor e llenőrzi az összes belső összetevőt.', 'Ideiglenes adattárolást biztosít a CPU számára.', '', '', 'D', '', 3, 1, 2),
(147, 'Egy hálózati kártya MAC címe hexadecimálisan: 01-40-F4-43-04-F3.\r\nMelyik a bináris megfelelője?', '0100000011110100010000110000010011110011', '000000010100000011110100010000110000010011110011', '00100000011110100010000110000010011110011', '000100000011110100001000000010100000010011110011', '', '', 'B', '', 3, 1, 2),
(148, 'Mi okozhatta azt, hogy a lézer nyomtató „csíkosan” nyomtatott a papírra?', 'A nyomtatószoftver gazdaságos üzemmódra van állítva.', 'A nyomtató szalagja elkopott.', 'A toner ben kevés a festék .', 'A nyomtatót fotópapír helyett más típusú papírral töltötték fel.', '', '', 'B', '', 3, 1, 2),
(149, 'Milyen színrendszert használnak a nyomtatók?', 'HSV', 'RGB', 'CMYK', 'CRY', '', '', 'C', '', 3, 1, 2),
(150, 'Melyik állítás igaz a ROM ra?', 'Tartalmát a gép kikapcsolásakor is megtartja', 'Bármelyik része közvetlenül megcímezhető, írható, olvasható', 'Működése mágneses technikán alapul', 'Mérete nagyban befolyásolja a gép sebességét', '', '', 'A', '', 3, 1, 2),
(151, 'Az alábbiak közül melyek az alkalmazási réteg protokolljai? (2 jó válasz)', 'POP3', 'ICMP', 'CSMA/CD', 'SMTP', 'TCP', '', 'A,D', '', 3, 2, 4),
(152, 'Az alábbiak közül melyik irányító protokoll?', 'OSF', 'PIR', 'EIGRP', 'SNMP', '', '', 'C', '', 3, 2, 2),
(153, 'Mit jelent a CSMA/CD csatornahozzáférési mód esetén a CD kifejezés?', 'vivőjel érzékelés', 'ütközés figyelés', 'ütközés elkerülés', 'ütközés megelőzés', '', '', 'B', '', 3, 2, 2),
(154, 'Melyik TCP/IP modell réteg felel meg az OSI első két rétegének?', 'Alkalmazási', 'Hálózatelérési', 'Szállítási', 'Internet', '', '', 'B', '', 3, 2, 2),
(155, 'Melyik IP-cím osztályba tartozik a 10.90.118.10 cím?', 'A', 'B', 'C', 'D', '', '', 'A', '', 3, 2, 2),
(156, 'Mi a hiba a következő IPv6-címmel: 2001:DB6:85a3::1319:8a2e::7348?', 'Nem FE80-al kezdődik', 'DB6 helyett 0DB6-ot kell írni, így nem érvényes a cím.', 'Két helyen van benne dupla kettőspont', 'Mindenhol dupla kettőspontnak kellene szerepelnie.', '', '', 'C', '', 3, 2, 2),
(157, 'Melyik alhálózati maszkkal egyezik meg a /19 alakú maszk?', '255.255.128.0', '255.255.192.0', '255.255.224.0', '255.255.240.0', '', '', 'C', '', 3, 2, 2),
(158, 'Mi a MAC-cím utolsó 24 bitjének rövidített neve?', 'OUI', 'LLC', 'NICS', 'MAC', '', '', 'C', '', 3, 2, 2),
(159, 'Mi a szórási címe a 180.168.120.100 állomás alhálózatának, ha /25-ös az alhálózati\r\nmaszkja?', '180.168.120.64', '180.168.120.95', '180.168.120.127', '180.168.120.255', '', '', 'C', '', 3, 2, 2),
(160, 'Milyen IPv6-cím a 2001:db8:a0b:12f0::1?', 'Csoportcím', 'Egyedi cím', 'Szórásos cím', 'Érvénytelen cím', '', '', 'B', '', 3, 2, 2),
(161, 'Melyik fogalom kapcsolódik WLAN-ok biztonságához?', 'WAP', 'VLAN', 'WPA2', 'VTP', '', '', 'C', '', 3, 2, 2),
(162, 'A forgalomirányító melyik memóriájában található az indító konfiguráció?', 'ROM', 'FLASH', 'NVRAM', 'RAM', '', '', 'C', '', 3, 2, 2),
(163, 'Mely alkalmazás - port párosok helyesek? (2 jó válasz)', 'ssh – 23', 'ftp – 21', 'smtp – 69', 'https - 443', '', '', 'B,D', '', 3, 2, 4),
(164, 'Melyik protokoll segítségével juthatnak IP címhez és hálózati információkhoz a\r\nhálózati eszközök? ', 'SNMP', 'IRC', 'DHCP', 'IMAP', '', '', 'C', '', 3, 2, 2),
(165, 'Hány host kaphat IP címet összesen a 10.200.54.0/24-es hálózatban?', '126', '128', '256', '254', '', '', 'D', '', 3, 2, 2),
(166, 'Az alábbiak közül a 168.100.100.20/27-es című állomás melyiknek nem küld közvetlen\r\nARP kérést, ha kommunikálni szeretne vele?', '168.100.100.10', '168.100.100.40', '168.100.100.30', '168.100.100.24', '', '', 'B', '', 3, 2, 2),
(167, 'Melyik az az üzenet, amelyet akkor küld egy állomás, ha ismert IP-címhez keres MACcímet?', 'ARP', 'BOOTP', 'DNS', 'RARP', '', '', 'A', '', 3, 2, 2),
(168, 'Milyen átviteli közeg látható az alábbi képen?', 'STP kábel', 'UTP kábel', 'Koax kábel', 'Optikai kábel', '', '', 'B', '2023_18.png', 3, 2, 2),
(169, 'Mi jellemző a kiterjesztett hozzáférési listákra? (2 jó válasz)', 'Csak az irányítandó IP csomagok forráscímét képes ellenőrizni.', 'Forrás, célcím, protokoll és port egyeztetésére egyaránt képesek.', 'Célhoz minél közelebbi router/interfészhez célszerű rendelni.', 'Forráshoz minél közelebbi interfészhez célszerű rendelni.', 'Csak nevesített módon használhatóak.', '', 'B,D', '', 3, 2, 4),
(170, 'Melyik az a PDU, amelyik az OSI modell 3. rétegében működik?', 'csomag', 'szegmens', 'keret', 'bitfolyam', '', '', 'A', '', 3, 2, 2),
(171, 'Mi okozhatja az interfész következő állapotát?\r\nSerial0/0/0 is down, line protocol is down (disabled)', 'rossz minőségű kábel', 'lekapcsolt interfész a kapcsolat túloldalán', 'eltérő beágyazási mód a kapcsolat két végén', 'aktív shutdown parancs az interfészen', '', '', 'A,B', '', 3, 2, 4),
(172, 'Melyik az a címzési mód, amely létezik az IPv6-ban, de az IPv4-ban nem?', 'Unicast', 'Anycast', 'Multicast', 'Broadcast', '', '', 'B', '', 3, 2, 2),
(173, 'Melyik fogalomhoz tartozik a következő meghatározás?\r\nA támadások egy speciális fajtája, amikor a támadó nem betörni akar, hanem egy adott\r\nszolgáltatás működését szeretné megbénítani.', 'Denial of Service (DoS)', 'DNS spoofing', 'Address spoofing', 'Portscan', '', '', 'A', '', 3, 2, 2),
(174, 'Melyik parancs jeleníti meg a routeren a RAM-ban tárolt aktív konfigurációt?', 'show active-config', 'show config', 'show running-config', 'show startup-config', '', '', 'C', '', 3, 2, 2),
(175, 'Milyen alrétegekre lehet osztani az adatkapcsolati réteget? (2 jó válasz)', 'DAT alréteg', 'MAC alréteg', 'LLC alréteg', 'PHZ alréteg', '', '', 'B,C', '', 3, 2, 4),
(176, 'Adott a következő tábla: CAR (rend_sz, marka, tipus, szin, kivitel, evjarat, listaar)\r\nMelyik SQL parancs kérdezi le a 2000 előtti évjáratú autók márkáját és típusát?', 'SELECT marka, tipus WHERE evjarat<2000 FROM car;', 'SELECT * FROM car WHERE evjarat<2000;', 'SELECT marka, tipus FROM car WHERE evjarat<2000;', 'SELECT marka, evjarat FROM car WHERE evjarat>2000;', '', '', 'C', '', 3, 3, 4),
(177, 'A fejlesztői csapat egy közös projekten dolgozik. Az elkészült kód központi repositoryja a https://github.com/user/project címen érhető el. Három branch van, beton, fejleszt\r\nés kiadas néven. Jelölje be az alábbiak közül az igaz állításokat! (2 jó válasz)', 'A repository helyi másolatát a git copy https://github.com/user/project paranccsal lehet elkészíteni\r\n', 'A kiadas branchre a git checkout kiadas paranccsal lehet átváltani.', 'A git commit paranccsal lehet a helyi változásokat a központi repositoryba feltölteni', 'A git pull paranccsal lehet a központi repositoryban levő változásokat letölteni.', '', '', 'B,D', '', 3, 3, 4),
(178, 'Adott a következő tábla: CAR (rend_sz, marka, tipus, szin, kivitel, evjarat, listaar)\r\nMi a hatása a következő SQL utasításnak?\r\nDELETE FROM car WHERE evjarat BETWEEN 2020 AND 2022;', 'Törli a car tábla összes adatát', 'Törli az evjarat mezőben lévő azon adatokat, amelyek 2020 és 2022 közé esnek.', 'Törli azon autók összes adatát, amelyeket 2020 és 2022 gyártottak.', 'Törli azon autók összes adatát, amelyeket 2020-ban vagy 2022-ben gyártottak', '', '', 'C', '', 3, 3, 4),
(179, 'Adott a következő tábla: CAR (rend_sz, marka, tipus, szin, kivitel, evjarat, listaar)\r\nMelyik SQL parancs ad hozzá egy kobcenti nevű mezőt a táblához? ', 'ADD TABLE car IN kobcenti INT;\r\n', 'CREATE TABLE car ADD kobcenti INT;\r\n', 'ALTER TABLE car ADD kobcenti INT;', 'UPDATE TABLE car ADD kobcenti INT;\r\n', '', '', 'C', '', 3, 3, 4),
(180, 'Hogyan kérdezhetőek le az autók nettó árai, ha a táblában csak a bruttó árakat és\r\nÁFA %-os értékét (pl.:25) tároljuk? (A nettó ár az ÁFÁ-val csökkentett ár)', 'SELECT brutto_ar-AFA AS nettó FROM autok;', 'SELECT brutto_ar-brutto_ar*AFA AS nettó FROM autok;', 'SELECT brutto_ar-brutto_ar*AFA/100 AS nettó FROM autok;\r\n', ' UPDATE berek SET brutto_ar-bruttó_ar*AFA/100 AS nettó;', '', '', 'C', '', 3, 3, 4),
(181, 'Mit eredményez a következő SQL utasítás?\r\nSELECT iskola,Avg(pont) AS [Átlagos pont]\r\nFROM verseny GROUP BY iskola\r\nHAVING (Avg(pont)>80);\r\n ', 'Megmutatja az iskolák átlagos pontszámait', 'Kikeresi azokat a tanulókat, akiknek a pontja 80 fölött van, és megadja az iskolájukat.\r\n', 'Kiírja azon iskolák számát, ahol az átlagos pontszám 80 felett volt.', 'Kikeresi azokat az iskolákat, ahol az átlagos pontszám 80 pont fölött van, és\r\nmegadja az átlagos pontszámukat.', '', '', 'D', '', 3, 3, 4),
(182, 'Adott a következő tábla: BOOK (konyv_ID, szerzo, cim, kategoria, kiado, kiadev, ar)\r\nMelyik SQL parancs növeli az összes könyv árát 20%-al?', 'UPDATE book SET ar=ar+20;', 'UPDATE book SET ar=ar*1.2;', 'ALTER TABLE book SET ar=ar*1.2', 'UPDATE book SET ar=ar*1.8 WHERE ar<5000;', '', '', 'B', '', 3, 3, 4),
(183, 'Melyik algoritmus-leíró eszköz látható az alábbi ábrán? ', 'folyamatábra', 'struktogram', 'Jackson-diagram', 'blokkdiagram', '', '', 'A', '2023_8.png', 3, 3, 2),
(184, 'Melyik vezérlési szerkezet általános alakja a következő? \r\nwhile (feltétel) {ciklusmag utasításai;}', 'kétirányú elágazás', 'növekményes ciklus', 'hátultesztelős ciklus', 'elöltesztelős ciklus', '', '', 'D', '', 3, 3, 2),
(185, 'Mit valósít meg a következő algoritmus?', 'Minimum-kiválasztásos rendezés', 'Közvetlen kiválasztásos rendezés', 'Buborékos rendezés', 'Beillesztéses rendezés', '', '', 'B', '2023_10.png', 3, 3, 2),
(186, 'Melyik kifejezés igaz az alábbiak közül?', '10101101B < 172D', '145D > 90H', '10111111B = BEH\r\n', '149D>10010111B', '', '', 'B', '', 3, 3, 2),
(187, 'Mi lesz a decimális eredmény, ha bitenkénti AND műveletet végzünk 8 biten a\nkövetkező két számon?', '28', '30', '31', '60', '', '', 'A', '2023_12.png', 3, 3, 2);
INSERT INTO `feladat` (`feladat_id`, `feladat_kerdes`, `feladat_a`, `feladat_b`, `feladat_c`, `feladat_d`, `feladat_e`, `feladat_f`, `feladat_helyes`, `feladat_kep`, `feladat_ev`, `feladat_tema`, `feladat_pont`) VALUES
(188, 'Az alábbiak közül mely adattípusok szolgálnak egész számok tárolására? (2 jó válasz)', 'char', 'short', 'long\r\n', 'float\r\n', 'double', '', 'B,C', '', 3, 3, 4),
(189, 'Melyik feltételt kell használnunk akkor, ha azt szeretnénk vizsgálni, hogy az adott évszám szökőév-e és egyben századforduló is?  ', 'evszam % 4 != 0 || evszam % 100 != 0 ', 'evszam % 4 != 0 && evszam % 100 != 0\r\n', 'evszam % 4 == 0 && evszam % 100 == 0', 'evszam % 4 == 0 || evszam % 100 == 0', '', '', 'C', '', 3, 3, 2),
(190, 'Mely kifejezések igazak az alábbiak közül? (2 jó válasz)', '10111001B < 180D', '145D > 90H\r\n', '10111111B = BAH', '148D<10010111B', '', '', 'B,D', '', 3, 3, 4),
(191, 'Mit csinál az alábbi programkód? ', 'Kiírja 12 osztóit a képernyőre, kivéve a 24-et, vesszővel elválasztva.', 'Kiírja a 12 osztóit a képernyőre vesszővel elválasztva.', 'Kiírja a 12 prímosztóit a képernyőre vesszővel elválasztva.', 'Kiírja a számokat 1-től 12-ig a képernyőre vesszővel elválasztva', '', '', 'B', '2023_16.png', 3, 3, 2),
(192, 'Melyik adattípus biztosítja a leggazdaságosabb tárhelyfoglalást, ha egy tornász\r\npontszámait szeretnénk eltárolni (a pontozó bírák által adható maximális pontszám\r\n10, és tizedes értékeket is adhatnak pl.: 8,6)? ', 'short', 'float\r\n', 'double', 'decimal', '', '', 'B', '', 3, 3, 2),
(193, 'Melyik adatmodell esetén alkalmazható az SQL nyelv?', 'hierarchikus', 'hálós', 'relációs', 'EER', '', '', 'C', '', 3, 3, 2),
(194, 'Melyik fogalomhoz tartozik a következő meghatározás?\r\nOlyan változó, ami egy memóriacímet tartalmaz.\r\n', 'Konstruktor', 'Destruktor', 'Metódus', 'Mutató', '', '', 'D', '', 3, 3, 2),
(195, 'Melyik HTML utasítással jelezhetjük egy felsorolás elemeit? ', '<dl>', '<li>', '<il>', '<list>', '', '', 'B', '', 3, 4, 2),
(196, 'Melyik HTML utasítás eredményez működő hiperhivatkozást? ', '<a href=\"http://www.parlament.hu\">Országgyűlés</a> ', '<a name=\"http://www.parlament.hu\">Országgyűlés</a>', '<a>http://www.parlament.hu</a>', '<a url=\"http://www.parlament.hu\">Országgyűlés</a>', '', '', 'A', '', 3, 4, 2),
(197, 'Az alábbiak közül melyik határoz meg jelölőnégyzet típusú űrlap mezőt?', '<input type=\"check\" name=\"foci\" value=\"1\">', '<form type=\"checkbox\" name=\"foci\" value=\"1\">', '<input type=\"checkbox\" name=\"foci\" value=\"1\">', '<input type=\"checkname=\"foci\" value=\"1\">', '', '', 'C', '', 3, 4, 2),
(198, 'Milyen tag-et kell használni a weboldalak táblázataiban a táblázat egy-egy cellájának\r\nmeghatározására?', '<cell>', '<td>', '<tr>', '<table>', '', '', 'B', '', 3, 4, 2),
(199, 'Melyik tag szolgál egy weboldalon képek beillesztésére? ', '<picture src=\"...\"> ', '<href img src=\"…\"> ', '<img href=\"…\"> ', '<img src=\"…\">', '', '', 'D', '', 3, 4, 2),
(200, 'Hogyan hozható létre egy weboldalon belül a „fejezet1” nevű könyvjelzőre mutató\r\nhivatkozás?', '<a name=\"#fejezet1\">Első fejezet</a>', '<a id=\"fejezet1\">Első fejezet</a>', '<a href=\"#fejezet1\">Első fejezet</a>', '<a href=\"fejezet1.html\">Első fejezet</a>', '', '', 'C', '', 3, 4, 2),
(201, 'HTML-ben melyik határoz meg egyszerű (egysoros) szöveges beviteli mezőt? ', '<text name=\"cím\" value=\"\">', '<select type=\"text\" name=\"cím\" value=\"\">', '<option type=\"text\" name=\"cím\" value=\"\">', '<input type=\"text\" name=\"cím\" value=\"\">', '', '', 'D', '', 3, 4, 2),
(202, 'Hogyan adható meg a HTML táblázatokban a keret vastagsága? ', 'a <table> \"line\" jellemzőjével\r\n', 'a <table> \"border\" jellemzőjével', 'a <table> \"margin\" jellemzőjével', 'a <table> \"width\" jellemzőjével', '', '', 'B', '', 3, 4, 2),
(203, 'Mire szolgál a HTML űrlapoknál az <input type=\"submit\"> tag? ', 'Szöveges beviteli mező elhelyezésére.', '\"Űrlap elküldése\" gomb elhelyezésére', 'Nyomógomb elhelyezésére', 'Az űrlap aláírására', '', '', 'B', '', 3, 4, 2),
(204, 'Melyik HTML utasítással csatolhatjuk a külső CSS fájlt a weblaphoz?', '<stylesheet> rel=\"stylesheet\" mystyle.css type=\"text/css\"</stylesheet>', '<link rel=\"stylesheet\" type=\"text/css\" href=\"mystyle.css\"> ', '<style src=\"mystyle.css\" rel=\"stylesheet\" type=\"text/css\">', '<a href=\"mystyle.css\" rel=\"stylesheet\" type=\"text/css\"></a>', '', '', 'B', '', 3, 4, 2),
(205, 'Hogyan épül fel általánosan egy CSS utasítás? ', 'kijelölö{tulajdonság1:ertek1;tulajdonsag2:ertek2;}\r\n', 'kijelölö{tulajdonság1,tulajdonsag2:ertek1,ertek2;}\r\n', '#tulajdonság{kijelölö: ertek1:ertek2;}', '.tulajdonság{kijelölö: ertek1:ertek2;}', '', '', 'A', '', 3, 4, 2),
(206, 'Melyik CSS utasítás igazítja jobbra a picture azonosítójú képet? ', '.picture{text-align:right}', '#picture{float:right}', '#picture{text-align:right}', '.picture{float:right}', '', '', 'B', '', 3, 4, 2),
(207, 'Melyik CSS utasítással készíthetünk egy olyan fejléckép azonosítójú szelektort, amely\r\na magasságot 50, a szélességet 800 képpontosra állítja?', '#fejléckép{height:800px;width:50px}', '.fejléckép{height:50px;width:800px}', '#fejléckép{height:50px;width:800px}', '.fejléckép{height:800px;width:50px}', '', '', 'C', '', 3, 4, 2),
(208, 'Mit eredményez a következő CSS utasítás: h2 {font-style:italic;} ', 'A címsort h2-re állítja', 'Hibás utasítás', 'A h2 címsor nyelvét olaszra állítja.', 'A h2 címsort dőltre állítja.', '', '', 'D', '', 3, 4, 2),
(209, 'Melyik CSS utasítással állíthatjuk a teljes weboldal betűtípusát Arialra?', 'body {text-style:Arial;}', 'text {font-family:Arial;}', 'body {font-family:Arial;}', 'body {text-family:Arial;}', '', '', 'C', '', 3, 4, 2),
(210, 'Mit végez el a következő CSS utasítás? #kép {width:200px;}', 'Az összes kép szélességét 200 pontosra állítja', 'A kép osztályú elem szélességét 200 pontosra állítja.', 'A kép azonosítójú elem szélességét 200 pontosra állítja.', 'Ez egy hibás utasítás.', '', '', 'C', '', 3, 4, 2),
(211, 'CSS-ben keretet szeretne készíteni a következő keretvastagságokkal:\r\nFelső keret = 10 képpont, alsó keret = 5 képpont, bal oldali keret = 20 képpont, jobb oldali keret = 1 képpont.\r\n\r\nMelyik a helyes parancs erre a célra? ', 'border-width:10px 20px 5px 1px;', 'border-width:10px 1px 5px 20px;', 'border-width:10px 5px 20px 1px;', 'd border-width:5px 20px 10px 1px;', '', '', 'B', '', 3, 4, 2),
(212, 'Melyik CSS utasítás szünteti meg a hiperhivatkozások aláhúzását?', 'a {text-decoration:none;}', 'a {underline:none;}', 'a {text-decoration:no-underline;}', '{decoration:no-underline;}', '', '', 'A', '', 3, 4, 2),
(213, 'Melyik JavaScript kód változtatja meg az alábbi proba azonosítójú bekezdésben\r\nmegjelenő szöveget?\r\n<p id=\"proba\">Jó reggelt!</p>', 'document.getElement(\"p\").innerHTML = \"Jó napot!\";', '#proba.innerHTML = \"Jó napot!\";', 'document.getElementByName(\"p\").innerHTML = \"Jó napot!\";', 'document.getElementById(\"proba\").innerHTML = \"Jó napot!\";', '', '', 'D', '', 3, 4, 2),
(214, 'Hogyan épül fel a számlálós ciklus ciklusfeje JavaScriptben? ', 'for i in range(1,5)', 'for i range(0;5)', 'for (i = 0; i <= 5; i++)', 'for (i <= 5; i++)', '', '', 'C', '', 3, 4, 2),
(215, 'Hogyan helyezhető el többsoros megjegyzés JavaScript kódban? ', '//Ez egy\r\ntöbbsoros megjegyzés//', '/*Ez egy\r\ntöbbsoros megjegyzés*/\r\n', '<!--Ez egy\r\ntöbbsoros megjegyzés-->', '//Ez egy\r\n//többsoros megjegyzés', '', '', 'B', '', 3, 4, 2),
(216, 'Az alábbiak közül melyik hoz létre 3 elemű tömböt JavaScriptben?', 'var colors = 1 = (\"red\"), 2 = (\"green\"), 3 = (\"blue\")', 'var colors = (1:\"red\", 2:\"green\", 3:\"blue\")', 'var colors = {\"red\", \"green\", \"blue\"}', 'var colors = [\"red\", \"green\", \"blue\"]', '', '', 'D', '', 3, 4, 2),
(217, 'Hogyan írhatjuk egy figyelmeztető ablakba a \"Hello\" szöveget JavaScriptben?', 'msg(\"Hello\");', 'alertBox(\"Hello\");', 'alert(\"Hello\"); ', 'msgBox(\"Hello\");', '', '', 'C', '', 3, 4, 2),
(218, ' Melyik HTML elembe kell elhelyezni a JavaScript kódot?', '<javascript> ', '<script> ', '<scripting>', '<js>', '', '', 'B', '', 3, 4, 2),
(219, 'JavaSriptben melyik metódussal adható meg két szám (x,y) közül a nagyobb?', 'Math.ceil(x, y)', 'ceil(x, y)\r\n', 'Math.max(x, y)', 'top(x, y)', '', '', 'C', '', 3, 4, 2),
(220, ' Mi lesz az x változó értéke a következő PHP kód lefutása után? ', '1', '5', '10', '15', '', '', 'A', '2023_26.png', 3, 4, 2),
(221, 'Mi lesz az x változó értéke a következő PHP kód lefutása után?', '2', '4', '5', '15', '', '', 'B', '2023_27.png', 3, 4, 2),
(222, 'PHP programnyelvben melyik utasítással nyitható meg a jelszo.txt fájl csak olvasásra?', 'open(\"jelszo.txt\");', 'fopen(\"jelszo.txt\",\"r\");', 'fopen(\"jelszo.txt\",\"r+\");', 'open(\"jelszo.txt\",\"read\");', '', '', 'B', '', 3, 4, 2),
(223, 'Melyik kifejezés hiányzik a mondatból?\r\nObjektumorientált programozás esetén a ______________ felelős az objektum által\r\nhasznált erőforrások felszabadításáért.', 'konstruktor', 'destruktor', 'metódus', 'virtuális metódus', '', '', 'B', '', 3, 4, 2),
(224, 'Mely állítások igazak az objektumorientált programozással (OOP) kapcsolatban?', 'A természetes gondolkodást, cselekvést közelítő programozási mód.', 'Csak vizuális programozási nyelven készíthetünk OOP programot.', 'A vizuális programozási nyelvben készített programok mindig objektumorientáltak', 'A mezők az adott osztály alapján létrehozott objektumpéldányok között nem\r\nkerülnek megosztásra, hanem minden példány külön-külön mezőkészlettel\r\nrendelkezik.', 'Az absztrakt osztályok a legtöbb nyelvben nem példányosíthatók.', 'Fontos jellemzőjük az öröklés, amely azt jelenti, hogy egy adott tevékenység (metódus)\r\nazonosítója közös lehet egy adott objektum hierarchián belül, ugyanakkor a hierarchia\r\nminden egyes objektumában a tevékenységeket végrehajtó metódus implementációja a', 'A,D,E', '', 3, 4, 6),
(225, 'OOP (objektumorientált programozás) estén melyik az a hozzáférési (láthatósági)\r\nszint, amelyben az adott taghoz csak az adott osztály és leszármazottjai férhetnek\r\nhozzá?', 'public', 'protected', 'internal', 'private', '', '', 'B', '', 3, 4, 2),
(226, 'Mekorra lesz az x változó értéke a következő Java kód lefutása után? ', '1', '4', '8', '24', '', '', 'C', '2023_32', 3, 4, 2),
(227, 'Melyik rendezési algoritmust valósítja meg a következő Java kód?', 'Minimum-kiválasztásos rendezés', 'Közvetlen kiválasztásos rendezés', 'Buborékos rendezés', 'Beillesztéses rendezés', '', '', 'C', '2023_33.png', 3, 4, 2),
(228, 'A szoftverfejlesztés melyik szakaszában definiálják a szoftver funkcióit, illetve annak megszorításait?', 'Szoftverspecifikáció\r\n', 'Szoftvertervezés és implementáció', 'Szoftvervalidáció', 'Szoftverevolúció', '', '', 'A', '', 3, 4, 2),
(229, 'Mely állítások igazak a szoftverfejlesztés során alkalmazott vízesésmodellre?', 'Alapja az iteráció, melynek segítségével eltérő szakaszokban ugyanazon fejlesztési\r\nterület kidolgozását teszi lehetővé a precízebb végeredmény érdekében.', 'Alapvető elgondolása, hogy az ügyfél által a tervezési fázisban felállított\r\nkövetelmények a fejlesztés során megváltozhatnak.', 'Egyszerű és könnyen menedzselhető felépítése miatt a kisebb és jól definiált\r\nprojektekhez gyakran használják.\r\n', 'A fejlesztést több részfolyamatra bontják és minden fázist az előző jóváhagyása és\r\nbefejezése után indítanak el.', 'Az általános fejlesztési eljárás helyett egy projektre szabható, igények szerint\r\nváltoztatható keretet nyújt.', '', 'C,D', '', 3, 4, 4),
(230, 'Határozza meg az alábbi algoritmus eredményét! ', 'N=2 X=9 K=4 ', 'N=4 X=10 K=3 ', 'N=6 X=5 K=1 ', 'N=7 X=10 K=3 ', '', '', 'B', '2023_36.png', 3, 4, 4),
(231, 'Mennyi lesz x és y értéke az alábbi programrészlet lefutásakor?', 'x=0 és y=3', 'x=3 és y=3 ', 'x=2 és y=3 ', 'x=3 és y=1', '', '', 'C', '2023_37.png', 3, 4, 4),
(232, ' Milyen értéket ad vissza az alábbi függvény X = 2022 esetén?', '1', '3', '20', '202', '', '', 'B', '2023_38.png', 3, 4, 4),
(233, 'Milyen értéket ad vissza az alábbi függvény N = 12 esetén? ', '1', '3', '20', '100', '', '', 'A', '2023_39.png', 3, 4, 4),
(234, 'Milyen tag-et kell használni a weboldalak táblázataiban a táblázat egy-egy fejléc\r\ncellájának meghatározására? ', '<cell> ', '<td>', '<head>', '<th>', '', '', 'D', '', 3, 4, 2),
(235, 'Az alábbiak közül melyik nem része egy HTML oldal szerkezetének?', 'header', 'body', 'caption', 'head', '', '', 'C', '', 3, 4, 2),
(236, 'Az alábbiak közül melyik nem része a HTML5 szemantikus szerkezetének?', 'header', 'main', 'nav', 'table', 'section', '', 'D', '', 3, 4, 2),
(237, 'Mi lesz az eredménye a css opacity:0.7; utasításnak, ha egy képre alkalmazzák?', 'semmi\r\n', 'a kép 30% ban átlátszó lesz\r\n', 'a kép fele részben átlátszó lesz', 'a kép 70% ban átlátszó lesz\r\n', '', '', 'B', '', 3, 4, 2),
(238, 'Az alábbiak közül melyik paraméter nem használható css-ben a háttér beállításainak\r\nmódosítására?', 'url(\"img_tree.png\");', 'no-repeat;\r\n', 'fixed\r\n', 'double', '', '', 'D', '', 3, 4, 2),
(239, ' CSS formázással szeretnék az oldalon egy képet középre igazítani úgy, hogy a\r\nkörnyező szövegektől külön sorba kerüljön. Mi kerüljön a display tulajdonság\r\nparaméterébe?', 'none', 'inline', 'block', 'inline-block', '', '', 'C', '', 3, 4, 2),
(240, 'Mire való egy HTML oldalon a meta tagbe elhelyezett viewport tulajdonság\r\nbeállítása?', 'nincs hatása a megjelenítésre', 'segítségével az eszköz méretéhez igazíthatjuk a tartalmak méretét', 'beállíthatjuk vele az oldalak legfelső szintjét\r\n', 'különféle nézőpontokat definiálhatunk vele', '', '', 'B', '', 3, 4, 2),
(241, 'Az alábbi CSS méret meghatározó mértékegységek közül melyik függ a megjelenítő\r\neszköz dpi felbontásától?', 'cm', 'px', 'pt', 'mm', '', '', 'B', '', 3, 4, 2),
...
--
ALTER TABLE `eredmenyek`
  MODIFY `eredmeny_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=37;
