...
(124, 'Ohm törvényének felhasználásával válassza ki, hogy mennyi lesz az U értéke, ha az R=76Ω és az I=1,2A?', '100V', '91,2V', '63,3V', '15,7V', '', '', 'B', '', 3, 0, 2),
...
(129, 'Az alábbi állítások közül melyik igaz a vírusokra?', 'Ha a rendszerbe vírus került, semmiképp sem irthat ó le a merevlemezen lévő vírusirtóval. Ki kell venni a rendszerlemezt és másik gépbe helyezni a sikeres írtáshoz .', 'Megfertőzheti a merevlemez boot szektorát, végső soron akár a teljes merevlemez tartalma elveszhet.', 'A vírusok egy speciális fajtája az elektro nikus sugárzáson keresztül is terjed, így egy kis irodában lévő minden számítógép gyorsan megfertőződhet.', 'A számítógépes vírusok egymásnak is ártanak, ezért egy gépen egyszerre csak egy vírus lehet jelen.', '', '', 'B', '', 3, 0, 2),
(130, 'Melyik parancs segítségével törölhető Linuxos rendszeren egy könyvtárból az\nösszes, csak „archiv” karakterekkel kezdődő állomány?', 'rm a*', 'del archiv*', 'rm archiv', 'rm archiv*', '', '', 'D', '', 3, 0, 2),
...
(136, ' Az alábbi eszközök közül melyikről nem lehet betölteni egy Pc operációs\nrendszerét? ', 'floppy lemez', 'CD-ROM', 'streamer kazetta', 'pendrive', '', '', 'C', '', 3, 0, 2),
(137, 'Egy CAD/CAM munkaállomás kialakításánál mely hardvereszköz kiemelt\nszerepű az alábbiak közül?', 'nagy teljesítményű videókártya', 'csúcsminőségű hangkártya', 'DisplayPort', 'fejlett hűtéstechnika', 'HDMI/DVI kimenet', '', 'A', '', 3, 0, 2),
...
(141, 'Videokártyacsere esetén mely szempont a legfontosabb? ', 'a gépbe szerelt RAM mérete', 'a gép CPU típusa', 'a beépített HDD mérete', 'az alaplapi bővítőhely típusa', '', '', 'D', '', 3, 0, 2),
...
(145, ' Egy videokártyán 600x400 képpont felbontásában 2 szín használható (fekete és\nfehér). Legalább mekkora memóriára van szüksége ennek megjelenítéséhez?', '240 000 Bájt', '30 000 Bájt', '0,24 Mbájt', '0,3 MBájt', '', '', 'B,D', '', 3, 0, 4),
...
(148, 'Mi okozhatta azt, hogy a lézer nyomtató „csíkosan” nyomtatott a papírra?', 'A nyomtatószoftver gazdaságos üzemmódra van állítva.', 'A nyomtató szalagja elkopott.', 'A toner ben kevés a festék .', 'A nyomtatót fotópapír helyett más típusú papírral töltötték fel.', '', '', 'B', '', 3, 0, 2),
