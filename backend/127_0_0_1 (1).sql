...
(244, 'Melyik állítás igaz az M2M technológiára?', 'Az M2M technológia az emberek közötti biztonságos és titkosított', 'Az M2M technológia olyan adatáramlást jelent, mely emberi közreműködés', 'Az M2M technológia a csoportmunka legújabb, egyben legfontosabb', 'Az M2M technológia minimum 20Gbit/s -os vonalon valósítható csak meg.', '', '', 'B', '', 2, 1, 2),
(245, 'Ohm törvényének felhasználásával válassza ki, hogy mennyi lesz az U értéke, ha az R=76Ω és az I=1,2A?', '100V', '91,2V', '63,3V', '15,7V', '', '', 'B,D', '', 2, 1, 2),
...
(256, 'Hol tárolódik a BIOS -ban beállított adat?', 'Az operatív tárban.', 'A BIOS és a CMOS tárolja', 'Háttértárolón', 'Az operációs rendszer gondoskodik a backupról.', '', '', 'B,D', '', 2, 1, 2),
...
(258, 'Egy CAD/CAM munkaállomás kialakításánál mely hardvereszköz kiemelt szerepű az alábbiak közül?', 'nagy teljesítményű videókártya', 'csúcsminőségű hangkártya', 'DisplayPort', 'fejlett hűtéstechnika', '', '', 'A', '', 2, 1, 2),
...
(262, 'Videokártyacsere esetén mely szempont  a legfo ntosabb ?', 'a gépbe szerelt RAM  mérete', 'a gép CPU típusa', 'a beépített HDD mérete', 'az alaplapi bővítőhely típusa', '', '', 'D', '', 2, 1, 2),
...
(266, 'Mi a CACHE funkciója?', 'Lehetővé teszi a számítógép számára a hálózathoz való csatlakozást.', 'A játékok és grafikus alkalmazások számára illesztő felületet biztosít.', 'A számítógép bekapcsolásakor e llenőrzi az összes belső összetevőt.', 'Ideiglenes adattárolást biztosít a CPU számára.', '', '', 'D', '', 2, 1, 2),
(267, 'Egy hálózati kártya MAC címe hexadecimálisan: 01 -40-F4-43-04-F3. Melyik a bináris megfelelője?', '0100000011110100010000110000010011110011', '000000010100000011110100010000110000010011110011', '00100000011110100010000110000010011110011', '000100000011110100001000000010100000010011110011', '', '', 'B,D', '', 2, 1, 2),
(268, 'Mi okozhatta azt, hogy a lézer  nyomtató „csíkosan” nyomtatott a papírra?', 'A nyomtatószoftver gazdaságos üzemmódra van állítva.', 'A nyomtató szalagja elkopott.', 'A toner ben kevés a festék .', 'A nyomtatót fotópapír helyett má s típusú papírral töltötték fel.', '', '', 'C', '', 2, 1, 2),
(269, 'Milyen színrendszert használnak a nyomtatók ?', 'HSV', 'RGB', 'CMYK', 'CRY', '', '', 'C', '', 2, 1, 2),
(270, 'Melyik állítás igaz a ROM -ra?', 'Tartalmát a gép kikapcsolásakor is megtartja', 'Bármelyik része közvetlenül megcímezhető, írható, olvasható', 'Működése mágneses  technikán alapul', 'Mérete nagyban befolyásolja a gép sebességét', '', '', 'A,D', '', 2, 1, 2),
(271, 'Az alábbiak közül melyek az alkalmazási réteg protokolljai ?', 'POP3', 'ICMP', 'CSMA/CD', 'SMTP', '', '', 'A,D', '', 2, 2, 4),
...
(275, 'Mi történik, ha nem, vagy hibásan adjuk meg az alapértelmezett átjáró címét egy hálózatra kötött gép konfigurálásakor?', 'A gép a belső hálózat gépeit el fogja érni.', 'A gép a belső és külső hálózat gépeit is eléri.', 'A gép csak a külső hálózat gépeit fogja elérni.', 'A gép semmilyen más géppel nem fog tudni kommunikálni.', '', '', 'A,D', '', 2, 2, 2),
...
(277, 'Mi a neve annak az eljárásnak, amikor belső IP címeket fordítunk át egy külső IP címre, és azzal érik el a belső hálózat gépei a távoli kiszolgálókat? ', 'NAI', 'PAI', 'NAT', 'ATP', '', '', 'C', '', 2, 2, 2),
(278, 'Mi a MAC -cím utolsó 24 bitjének rövidített neve?', 'OUI', 'LLC', 'NIC', 'MAC', '', '', 'C', '', 2, 2, 2),
(279, 'Mi a szórási címe a 180.168.120.100 állomás alhálózatának, ha /2 5-ös az alhálózati maszkja? ', '180.168.120.64', '180.168.120.95', '180.168.120.127', '180.168.120.255', '', '', 'C', '', 2, 2, 2),
(280, 'Milyen IPv6 -cím a 2001:db8:a0b:12f0::1?', 'Csoportcím', 'Egyedi cím', 'Szórásos cím', 'Érvénytelen cím', '', '', 'B', '', 2, 2, 2),
(281, 'Melyik fogalom kapcsolódik WLAN -ok biztonságához?', 'WAP', 'VLAN', 'WPA 2', 'VTP', '', '', 'C,D', '', 2, 2, 2),
...
(284, 'Hogyan vehetjük rá a kapcsolókat, hogy megtanulják a hozzájuk kapcsolt gépek MAC címét, és csak a megtanult címet fogadják el a későbbiekben?', 'switchport port -security mac -address sticky', 'switchport port-security mac -address dc -49-a9-3a-6c-73', 'switchport port -security', 'switchport port -secutritiy aging static', '', '', 'A', '', 2, 2, 2),
(285, 'Melyik protokoll segítségével juthatnak IP címhez és hálózati információkhoz a hálózati eszközök?', 'SNMP', 'IRC', 'DHCP', 'IMAP', '', '', 'C', '', 2, 2, 2);
INSERT INTO `feladat` (`feladat_id`, `feladat_kerdes`, `feladat_a`, `feladat_b`, `feladat_c`, `feladat_d`, `feladat_e`, `feladat_f`, `feladat_helyes`, `feladat_kep`, `feladat_ev`, `feladat_tema`, `feladat_pont`) VALUES
(286, 'Mi az , ami az UDP protokollból hiányzik, de a TCP protokollban benne van ?', 'Hibadetektálás.', 'Adatkommunikáció kiépítésének képessége.', 'IP címek használata .', 'Nyugtázás .', '', '', 'C,D', '', 2, 2, 2),
(287, 'Az alábbiak közül a 168.100.100.20/27 -es című állomás melyiknek nem küld közvetlen ARP kérést, ha kommunikálni szeretne vele? ', '168.100.100.1 0', '168.100.100.40', '168.100.100.30', '168.100.100.24', '', '', 'B', '', 2, 2, 2),
(288, 'Melyik az az üzenet, amelyet akkor küld egy állomás, ha ismert IP -címhez keres MAC -címet? ', 'ARP', 'BOOTP', 'DNS', 'RARP', '', '', 'A', '', 2, 2, 2),
(289, 'Milyen átviteli közeg látható az alábbi képen?', 'STP kábel', 'telefon kábel', 'UTP kábel', 'Optikai kábel', '', '', 'B', '2024_19.png', 2, 2, 2),
(290, 'Mi jellemző a kiterjesztett hozzáférési listákra?', 'Csak az irányítandó IP csomagok forrás címé t képes ellenőrizni.', 'Forrás, célcím, protokoll és port egyeztetésére egyaránt képesek.', 'Célhoz minél közelebbi router/interfészhez célszerű rendelni.', 'Forráshoz minél közelebbi interfészhez célszerű rendelni.', '', '', 'B,D,E', '', 2, 2, 4),
(291, 'Milyen program alkalmas leginkább egy számítógép hálózati adatforgalmának kontrollálására?', 'Tűzfal', 'Vírusírtó', 'Házirend', 'Reklámblokkoló', '', '', 'A', '', 2, 2, 2),
(292, 'Mi okozhatja az interfész következő állapotát?', 'rossz minőségű kábel', 'lekapcsolt interfész a kapcsolat túloldalán', 'eltérő beágyazási mód a kapcsolat két végén', 'aktív shutdown parancs az interfészen', '', '', 'A,B', '', 2, 2, 2),
...
(295, 'Melyik állítás igaz a Bluetooth technológiára ?', '802.11b szabványt használ.', '2,5 Ghz -es frekvenciasávban működik.', '2,4 Ghz -es frekvenciasávban működik.', 'Csak hang átvitelére használják.', '', '', 'A,B,C,D', '', 2, 2, 2),
(296, 'Milyen alrétegekre lehet osztani az adatkapcsolati réteget?', 'DAT alréteg', 'MAC alréteg', 'LLC alréteg', 'PHZ alréteg', '', '', 'B,C', '', 2, 2, 4),
...
(299, 'Melyik parancs segítségével  lehet ki listáz ni „A” és „B” táblából azok at a rekordok at, amik mind a két táblában szerepelnek?', 'SELECT * FROM A INNER JOIN B ON A .kulcs=B.kulcs', 'SELECT * FROM A RIGHT JOIN B ON A.kulcs=B.kulcs WHERE A.kulcs IS NULL', 'SELECT * FROM A FULL OUTER JOIN B ON A.kulcs=B.kulcs WHERE A.kulcs IS', 'SELECT * FROM A RIGHT JOIN  B ON A.kulcs=B.kulcs WHERE B .kulcs IS NULL', '', '', 'A,D', '', 2, 3, 2),
(300, 'Melyik parancs segítségével  lehet ki listáz ni „A” és „B” táblából azokat a rekordokat, amik csak az A vagy csak a B táblában szerepelnek? ', 'SELECT * FROM A INNER JOIN B ON A.kulcs=B.kulcs', 'SELECT * FROM A RIGHT JOIN B ON A.kulcs=B.kulcs WHERE A.kulcs IS NULL', 'SELECT * FROM A FULL OUTER JOIN B ON A.kulcs=B.kulcs WHERE A.kulcs IS', 'SELECT * FROM A RIGHT JOIN  B ON A.kulcs=B.kulcs WHERE B .kulcs IS NULL', '', '', 'C', '', 2, 3, 2),
(301, 'Adott a következő tábla: CAR  (rend_sz , marka , tipus , szin, kivitel , evjarat , listaar) Melyik SQL parancs kérdezi le a 2023 előtti évjáratú autók márkáját és típusát?', 'SELECT marka, tipus  WHERE evjarat <2023 FROM car;', 'SELECT * FROM car WHERE evjarat <2023;', 'SELECT marka, tipus FROM car WHERE evjarat<20 23;', 'SELECT marka, evjarat  FROM car WHERE evjarat >2023;', '', '', 'C', '', 2, 3, 2),
...
(304, 'Adott a következő tábla: CAR  (rend_sz , marka , tipus , szin, kivitel , evjarat , listaar) Melyik SQL parancs ad hozzá egy teljesitmeny nevű mezőt a táblához? ', 'ADD TABLE car IN teljesitmeny  INT;', 'CREATE TABLE car ADD teljesitmeny  INT;', 'ALTER TABLE car ADD teljesitmeny  INT;', 'UPDATE TABLE car ADD teljesitmeny  INT;', '', '', 'C', '', 2, 3, 2),
(305, 'Adott a következő tábla: CAR  (rend_sz , marka , tipus , szin, kivitel , evjarat , listaar) Melyik SQL parancs segítségével tudja kilistázni azon autók adatait, amik többe\nkerülnek, mint a Mazda MX5-ös model?', 'SELECT * FROM car WHERE listaar>Mazda.MX5.listaar ;', 'SELECT * FROM car WHERE car.listaar>(SELECT * FROM car  WHERE', 'SELECT * FROM car WHERE car.listaar>(SELECT listaar FROM car WHERE', 'SELECT * FROM car WHERE listaar>(SELECT marka=’Mazda’ AND tipus=’MX5’) ;', '', '', 'C', '', 2, 3, 2),
(306, 'Mit eredményez a következő SQL utasítás?', 'Megmutatja az iskolák átlagos pontszámait', 'Kikeresi azokat a tanulókat, akiknek a pontja 80 fölött van, és megadja az iskolájukat.', 'Kiírja azon iskolák számát, ahol az átlagos pontszám 80 felett volt.', 'Kikeresi azokat az iskolákat, ahol az átlagos pontszám 80 pont fölött van, és megadja', '', '', 'D', '', 2, 3, 2),
(307, 'Adott a következő tábla: BOOK (konyv_ID, szerzo, cim, kategoria, kiado, kiadev, ar) Melyik SQL parancs növeli az összes könyv árát 20%-al?', 'UPDATE book SET ar=ar+20;', 'UPDATE book SET ar=ar*1.2;', 'ALTER TABLE book SET ar=ar*1.2', 'UPDATE book SET ar=ar*1.8 WHERE ar<5000;', '', '', 'B,D', '', 2, 3, 2),
...
(309, 'Melyik vezérlési szerkezet általános alakja a következő? do{ciklusmag utasításai;}while (feltétel) ', 'kétirányú elágazás', 'növekményes ciklus', 'hátultesztelős ciklus', 'elöltesztelős ciklus', '', '', 'C', '', 2, 3, 2),
(310, 'Mit valósít meg a következő algoritmus?', 'Minimum -kiválasztásos rendezés', 'Közvetlen kiválasztásos rendezés', 'Buborékos rendezés', 'Beillesztéses rendezés', '', '', 'B,D', '2024_14.png', 2, 3, 4),
(311, 'Melyik kifejezés igaz az alábbiak közül?', '10101101 B < 172 D', '145 D > 90 H', '10111111 B = BE H', '149 D>10010111 B', '', '', 'B', '', 2, 3, 2),
(312, 'Mi lesz a decimális eredmény, ha bitenkénti  AND műveletet végzünk 8 biten a következő két számon?', '28', '30', '31', '60', '', '', 'A', '2024_16.png', 2, 3, 2),
(313, 'Az alábbiak közül mely adattípusok szolgálnak egész számok tárolására?  ', 'char', 'short', 'long', 'float', '', '', 'B,C', '', 2, 3, 4),
(314, 'Melyik feltételt kell használnunk akkor, ha azt szeretnénk vizsgálni, hogy az adott évszám szökőév-e és egyben századforduló is?', 'evszam % 4 != 0', 'evszam % 100 != 0', 'evszam % 4 != 0 && evszam % 100 != 0', 'evszam % 4 == 0 && evszam % 100 == 0', 'evszam % 4 == 0', 'evszam % 100 == 0', 'C', '', 2, 3, 2),
(315, 'Mely  kifejezések igazak az alábbiak közül? ', '10111001 B < 180 D', '145 D > 8FH', '10111111 B = BA H', '150D<10010111 B', '', '', 'B,D', '', 2, 3, 4),
(316, 'Melyik adattípus biztosítja a leggazdaságosabb tárhelyfoglalást, ha egy tornász pontszámait szeretnénk eltárolni (a pontozó bírák által adható maximális pontszám \n10, és tizedes értékeket is adhatnak pl.: 8,6)?', 'short', 'float', 'double', 'decimal', '', '', 'B', '', 2, 3, 2),
(317, 'Melyik adatmodell esetén alkalmazható az SQL nyelv?', 'hierarchikus', 'hálós', 'relációs', 'EER', '', '', 'C', '', 2, 3, 2),
(318, 'Melyik fogalomhoz tartozik a következő meghatározás?', 'Konstruktor', 'Destruktor', 'Metódus', 'Mutató', '', '', 'D', '', 2, 3, 2),
...
(320, 'Mi nem igaz az algoritmusra?', 'A feladat megoldásában mind a lépések számának, mind az egyes lépéseknek végesnek', 'Minden lépésnek egyértelműnek kell lennie, hogy ne lehessen félreérteni.', 'Fontos, hogy minden lépés elvégezhető legyen.', 'Csak valamilyen algoritmus leíró nyelven készülhet.', '', '', 'D', '', 2, 3, 2),
...
(323, 'Mit csinál az alábbi programkód?', 'Kiírja 12 osztóit a képernyőre, kivéve a 12-öt, vesszővel elválasztva.', 'Kiírja a 12 osztóit a képernyőre vesszővel elválasztva.', 'Kiírja a 12 prímosztóit a képernyőre vesszővel elválasztva.', 'Kiírja a számokat 1 -től 12 -ig a képernyőre vesszővel elválasztva.', '', '', 'B,D', '2024_1.png', 2, 4, 2),
...
(328, 'Milyen tag -et kell használni a weboldalak táblázataiban a táblázat egy -egy cellájának meghatározására? ', '<cell>', '<td>', '<tr>', '<table>', '', '', 'B,D', '', 2, 4, 2),
...
(330, 'Hogyan hozható létre egy weboldalon belül a „fejezet1” nevű könyvjelzőre mutató hivatkozás?', '<a name=\"#fejezet1\">Első fejezet</a>', '<a id=\"fejezet1\">Első fejezet</a>', '<a href=\"#fejezet1\">Első fejezet</a>', '<a href=\"fejezet1.html\">Első fejezet</a>', '', '', 'C', '', 2, 4, 2),
...
(334, 'Melyik HTML utasítással csatolhatjuk a külső CSS fájlt a weblaphoz?', '<stylesheet>  rel=\" stylesheet\" mystyle.css  type=\"text/css\" </stylesheet>', '<link rel=\"stylesheet\" type=\"text/css\" href=\"mystyle.css\">', '<style src=\"mystyle.css\"  rel=\"stylesheet\"  type=\"text/css\" >', '<a href=\"mystyle.css\"  rel=\"stylesheet\"  type=\"text/css\" ></a>', '', '', 'B,D', '', 2, 4, 2),
...
(337, 'Melyik CSS utasítással készíthetünk egy olyan „side”  azonosítójú szelektort, amely a magasságot 500, a szélességet 80 képpontosra állítja? ', '#side{height:80px;width:5 00px}', '.side{height:5 00px;width:80px}', '#side{height:5 00px;width:80px}', '.side{height:80px;width:5 00px}', '', '', 'C', '', 2, 4, 2),
(338, 'Mit eredményez  a következő CSS utasítás: h2 { text-decoration :underline ;}', 'A címsort h2 -re állítja.', 'Hibás utasítás.', 'A h2 címsor t színesre állítja .', 'A h2 címsort aláhúzottra  állítja.', '', '', 'D', '', 2, 4, 2),
(339, 'Melyik CS S utasítással állíthatjuk a weboldal  „menü” elemének  betűtípusát Arialra?', 'body {text -style:Arial;}', 'text {font -family:Arial;}', 'menu  {font -family:Arial;}', 'body {text -family:Arial;}', '', '', 'C', '', 2, 4, 2),
(340, 'Mit végez el a következő CSS utasítás? #kép {width:200px;}', 'Az összes kép szélességét 200 pontosra állítja.', 'A kép osztályú elem szélességét 200 pontosra állítja.', 'A kép azonosítójú elem szélességét 200 pontosra állítja.', 'Ez egy hibás utasítás.', '', '', 'C,D', '', 2, 4, 2),
...
(343, 'Melyik JavaScript kód változtatja meg az alábbi „proba ” azonosítójú bekezdésben megjelenő szöveget?', 'document.getElement(\"p\").innerHTML = \"Jó napot!\";', '#proba.innerHTML = \"Jó napot!\";', 'document.getElementByName(\"p\").innerHTML = \"Jó napot!\";', 'document.getElementById(\"proba\").innerHTML = \"Jó napot!\";', '', '', 'D', '', 2, 4, 2),
(344, 'Hogyan épül fel a számlálós ciklus ciklusfeje JavaScriptben?', 'for i in range( 1,5)', 'for i range( 0;5)', 'for (i = 0; i <= 5; i++)', 'for (i <= 5; i++)', '', '', 'C,D', '', 2, 4, 2),
(345, 'Hogyan helyezhető el többsoros megjegyzés python  kódban?', '//Ez egy', '/*Ez egy', '<!--Ez egy', '”””', '', '', 'D', '', 2, 4, 2),
...
(349, 'JavaSriptben melyik metódussal csonkolható  egy tört  szám egészre ?', 'Math. pow()', 'round ()', 'Math.floor( )', 'Math.round( )', '', '', 'C,D', '', 2, 4, 2),
...
(352, 'PHP programnyelvben melyik utasítással nyi tható meg a jelszo.txt fájl  olvasásra  és írásra?', 'open(\"jelszo.txt\");', 'fopen(\"jelszo.txt\",\"r\");', 'fopen(\"jelszo.txt\",\"r+\");', 'open (\"jelszo.txt\",\"rw \");', '', '', 'C,D', '', 2, 4, 2),
(353, 'Mely állítások igazak az objektumorientált programozással (OOP) kapcsolatban?', 'A természetes gondolkodást, cselekvést közelítő programozási mód.', 'Csak vizuális programozási nyelven készíthetünk OOP programot.', 'A vizuális programozási nyelvben készített programok mindig objektumorientáltak.', 'A mezők az adott osztály alapján létrehozott objektumpéldányok között nem kerülnek', '', '', 'A,D,E', '', 2, 4, 6),
(354, 'Mekorra lesz az x változó értéke a következő Java kód lefutása után?', '1', '4', '8', '24', '', '', 'C,D', '2024_32.png', 2, 4, 2),
...
(359, 'Mennyi lesz x és y értéke az alábbi programrészlet lefutásakor?', 'x=0 és y=3', 'x=3 és y=3', 'x=2 és y=3', 'x=3 és y=1', '', '', 'C,D', '2024_37.png', 2, 4, 4),
(360, 'Mi kerül a képernyőre az alábbi program futásának eredményeként ?', '3', '7', '5', '8', '', '', 'D', '2024_38.png', 2, 4, 4),
(361, 'Milyen értéket ad vissza az alábbi függvény X = 2023 esetén?', '1', '3', '20', '202', '', '', 'B,D', '2024_39.png', 2, 4, 4),
(362, 'Milyen értéket ad vissza az alábbi függvény N = 12 esetén?', '1', '3', '20', '100', '', '', 'A', '2024_40.png', 2, 4, 4),
(363, 'Milyen tag -et kell használni a weboldalak táblázataiban a táblázat egy -egy fejléc cellájának meghatározására?', '<cell>', '<td>', '<head>', '<th>', '', '', 'D', '', 2, 4, 2),
(364, 'Az alábbiak közül melyik nem része egy HTML oldal szerkezetének?', 'header', 'body', 'caption', 'head', '', '', 'C', '', 2, 4, 2),
(365, 'Az alábbiak közül melyik nem része a HTML5 szemantikus szerkezetének?', 'header', 'main', 'nav', 'table', '', '', 'D,E', '', 2, 4, 2),
...
(367, 'Az alábbiak közül melyik paraméter nem használható css -ben a háttér  beállításainak módosítására?', 'url(\"img_tree.png \");', 'no-repeat;', 'fixed', 'double', '', '', 'D', '', 2, 4, 2),
...
(370, 'Az alábbi CSS méret meghatározó mértékegységek közül melyik függ a megjelenítő eszköz dpi felbontásától?', 'cm', 'px', 'pt', 'mm', '', '', 'B,D', '', 2, 4, 2),
(371, 'Az alábbiak közül melyik CSS szelektorral lehet hivatkozni az összes  olyan bekezdésre, amik a div elemen belül helyezkednek el?', 'div, p', 'div p', 'div>p', 'div+p', '', '', 'B', '', 2, 4, 2),
